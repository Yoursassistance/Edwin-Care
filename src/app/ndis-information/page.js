  ...
  return (
    <div className="w-[100%]">
      ...
      <div className="px-[8%] py-[5%] text-[#6A00C6]">
        <div>
          <h1 className="text-[48px] font-bold max-[768px]:text-[28px]">
            Welcome to NDIS Information Hub
          </h1>
          <div>
            <h1 className="text-[24px] text-[#7A7A7A] mt-[3%] max-[768px]:text-[16px]">
              Understanding the National Disability Insurance Scheme (NDIS)
            </h1>
            <p className="text-[20px] text-[#979797] w-[70%] mt-[1%] max-[768px]:text-[14px] max-[768px]:w-[100%]">
          ...
          <div>
            <h1 className="text-[24px] text-[#7A7A7A] mt-[3%] max-[768px]:text-[18px]">
              What is the NDIS?
            </h1>
      ...
      <div className="text-center px-[8%] my-[5%]">
        <div>
          <h1 className="text-[32px] font-bold text-[#0B69FF] max-[768px]:text-[24px]">
            Welcome to NDIS Information Hub
          </h1>
      ...
      <div className="text-center px-[8%] my-[5%]">
        <div>
          ...
          <div className="text-left mt-[3%]">
            ...
            <h1 className="text-[20px] text-[#7A7A7A] mt-[1%] w-[70%] max-[768px]:w-[100%] max-[768px]:text-[16px]">
