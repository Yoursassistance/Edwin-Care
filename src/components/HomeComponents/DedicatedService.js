...
const DedicatedService = () => {
  return (
    <div className="px-[15%] bg-[#F8F9FE] py-[4%] max-[768px]:px-[8%] max-[768px]:py-[8%]">
      <div>
        <div>
          <h1 className="text-[#6A00C6] text-[42px] font-semibold max-[768px]:text-[28px] w-[100%]">
        ...
        <div className="flex justify-between mt-[5%] pb-[5%] max-[768px]:flex-col">
          <div className="w-[30%] max-[768px]:w-[100%] max-[768px]:my-[3%] max-[768px]:mb-[15%]">
            ...
            <div className="bg-[#FDE101] py-[15px] px-[1%] rounded-[10px] w-[8%] ml-[1.5%] flex flex-col justify-start items-left mt-[-3%] absolute max-[768px]:w-[40%] max-[768px]:pl-[5%] max-[768px]:mt-[-7%]">
              <h1 className="text-[14px] font-bold max-[768px]:text-[14px]">in-Home</h1>
              <h1 className="text-[18px] font-bold max-[768px]:text-[18px]">Support</h1>
            </div>
          </div>
          <div className="w-[30%] max-[768px]:w-[100%] max-[768px]:my-[3%] max-[768px]:mb-[15%]">
            <Image src={sPart} />
            <div className="bg-[#FDE101] py-[15px] px-[1%] rounded-[10px] w-[10%] ml-[1.5%] flex flex-col justify-start items-left mt-[-3%] absolute max-[768px]:w-[40%] max-[768px]:pl-[5%] max-[768px]:mt-[-7%]">
              <h1 className="text-[14px] font-bold max-[768px]:text-[14px]">Social & Community</h1>
              <h1 className="text-[18px] font-bold max-[768px]:text-[18px]">Participation</h1>
            </div>
          </div>
          <div className="w-[30%] max-[768px]:w-[100%] max-[768px]:my-[3%] max-[768px]:mb-[10%]">
            <Image src={ySupport} />
            <div className="bg-[#FDE101] py-[15px] px-[1%] rounded-[10px] w-[8%] ml-[1.5%] flex flex-col justify-start items-left mt-[-3%] absolute max-[768px]:w-[40%] max-[768px]:pl-[5%] max-[768px]:mt-[-7%]">
              <h1 className="text-[14px] font-bold max-[768px]:text-[14px]">Youth</h1>
              <h1 className="text-[18px] font-bold max-[768px]:text-[18px]">Support</h1>
            </div>
          </div>
        </div>
