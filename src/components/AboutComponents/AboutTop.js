...
const AboutTop = () => {
  return (
    <div className="w-[100%]">
      <div className="bg-[#0B69FF] text-[white] flex items-center py-[1%] px-[8%] justify-between max-[768px]:py-[2%]">
        ...
        <div className="flex w-[30%] items-end max-[768px]:w-[100%]">
          <div className="flex items-center w-[100%] justify-end max-[768px]:justify-start">
            <Image
              src={whatsapp}
              width="100%"
              className="mr-[2%] max-[768px]:w-[5%]"
            />
            <a href="https://wa.link/v8f0pa">Connect on Whatsapp</a>
          </div>
        </div>
      </div>
    </div>
