  ...
  return (
    <div className="flex  px-[2%] py-[1%] items-center mt-[2%] bg-white mx-[8%] shadow-lg">
      <div className="flex items-center w-[50%]">
        <Link href="/" className="mr-[2%] text-[#979797] text-[14px]">Home</Link>
        ...
        <Link href="/ndis-information" className="mr-[2%] font-bold text-[#F42BD3] text-[16px]">NDIS Information</Link>
      ...
      <div className="flex items-center w-[25%]">
        ...
        <div className="w-[50%]">
          <button className="bg-[#F42BD3] text-[#ffffff] px-[20%] py-[10%] rounded-[5px]">
            Get in touch
          </button>
        </div>
      </div>
